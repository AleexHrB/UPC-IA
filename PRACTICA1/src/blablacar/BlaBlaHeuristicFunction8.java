//package src.blablacar; NO PUTO COMPILA
 ...
 * @author Walter J.T.V
 */
public class BlaBlaHeuristicFunction8 implements HeuristicFunction{

    /**
     * @param state This is a non-instanciated state 
     * @return Entropy of the sum of the remaining distance to work from each user multiplied by the number of cars
     */
    public double getHeuristicValue(ArrayList<ArrayList<XYLocation>> state){
        ...
        return h * Math.log(h) * NumberOfCars;
