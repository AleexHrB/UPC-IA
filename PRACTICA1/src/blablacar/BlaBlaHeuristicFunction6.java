 ...
 * @author Walter J.T.V
 */
public class BlaBlaHeuristicFunction6 implements HeuristicFunction{

    /**
     * @param state This is a non-instanciated state 
     * @return The sum of the squared remaining distance to work, divided by the number of users. Kind of the arithmetic average
     */
