...
(:action asignada_adicional_uno 
    ...
    :precondition (and (not (es_tipo_tres ?t)) (valida ?t) (es_tarea_adicional ?t) (not (es_tarea_prohibida ?t ?p)) (not (asignada ?t)))
    :effect (and (asignada ?t))
)

(:action asignada_adicional_dos
    :parameters (?p - programador_dos ?t - tarea)
    :precondition (and (es_tarea_adicional ?t) (valida ?t) (not (es_tarea_prohibida ?t ?p)) (not (asignada ?t)))
    :effect (and (asignada ?t))
)
